...
class PARSERS_EXPORT SAX2XMLReaderImplLoc :
	public XMemory
...
private :
    ...
    // -----------------------------------------------------------------------
    SAX2XMLReaderImplLoc(const SAX2XMLReaderImplLoc&);
    SAX2XMLReaderImplLoc& operator=(const SAX2XMLReaderImplLoc&);
...
// ---------------------------------------------------------------------------
inline ContentHandler* SAX2XMLReaderImplLoc::getContentHandler() const
{
    return fDocHandler;
}

inline DTDHandler* SAX2XMLReaderImplLoc::getDTDHandler() const
{
	return fDTDHandler ;
}

inline EntityResolver* SAX2XMLReaderImplLoc::getEntityResolver() const
{
	return fEntityResolver;
}

inline XMLEntityResolver* SAX2XMLReaderImplLoc::getXMLEntityResolver() const
{
	return fXMLEntityResolver;
}

inline ErrorHandler* SAX2XMLReaderImplLoc::getErrorHandler() const
{
	return fErrorHandler;
}

inline PSVIHandler* SAX2XMLReaderImplLoc::getPSVIHandler() const
{
	return fPSVIHandler;
}

inline LexicalHandler* SAX2XMLReaderImplLoc::getLexicalHandler() const
{
   return fLexicalHandler;
}

inline DeclHandler* SAX2XMLReaderImplLoc::getDeclarationHandler() const
{
   return fDeclHandler;
}

inline bool SAX2XMLReaderImplLoc::getExitOnFirstFatalError() const
{
    return fScanner->getExitOnFirstFatal();
}

inline bool SAX2XMLReaderImplLoc::getValidationConstraintFatal() const
{
    return fScanner->getValidationConstraintFatal();
}

inline Grammar* SAX2XMLReaderImplLoc::getRootGrammar()
{
    return fScanner->getRootGrammar();
}

inline const XMLCh* SAX2XMLReaderImplLoc::getURIText(unsigned int uriId) const
{
    return fScanner->getURIText(uriId);
}

inline XMLFilePos SAX2XMLReaderImplLoc::getSrcOffset() const
{
